...
namespace stay_link.Server.Migrations
{
    ...
    [Migration("20250416201920_RemovingHotelEntity2")]
    partial class RemovingHotelEntity2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stay_link.Server.Models.RoomClosure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("RoomId")
                        .HasDatabaseName("i_x_room_closure_room_id");

                    b.ToTable("room_closure");
                });
            ...
            modelBuilder.Entity("stay_link.Server.Models.RoomClosure", b =>
                {
                    b.HasOne("stay_link.Server.Models.Room", "Room")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_room_closure_rooms_room_id");
