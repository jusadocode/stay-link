...
namespace stay_link.Server.Migrations
{
    ...
    [Migration("20250330174914_DbTableRenamesUnderscoresAgain")]
    partial class DbTableRenamesUnderscoresAgain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("stay_link.Server.Models.BookingFeature", b =>
                {
                    ...
                    b.ToTable("booking_features", (string)null);
                });
            ...
            modelBuilder.Entity("stay_link.Server.Models.RoomUsage", b =>
                {
                    ...
                    b.ToTable("room_usage", (string)null);
                });
